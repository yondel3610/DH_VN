...
label ch3_question_menu:
    ...
    menu:
        ...
        "I'm done asking questions for now.":
            "Elias licked the last bit of syrup from his fingers, his tiny face now a sticky mess once more."

            voice audio.dorian_ch3_line18
            dorian "I think I'm done asking questions for now."
...
label ch3_blizzard_trapped:
    ...
    show elias first_meet_happy at right_elias with Dissolve(0.2)
    voice audio.elias_ch3_line16
    elias "It smells soooo good. Like... um... like happy smells!"

    show dorian normal_alt_neutral at left_char with Dissolve(0.2)
    voice audio.dorian_ch3_line22
    dorian "Happy smells?"
    ...
    voice audio.elera_ch3_line2
    elara "Well then, why did you accept it?"
    voice audio.dorian_ch3_line28
...
label ch3_yuxuan_arrives:
    ...
    voice audio.elera_ch3_line9
    elara "Go, my heart. Ena is counting on you."
    voice audio.elera_ch3_line10
...
label ch3_mushroom:
    ...
    voice audio.dorian_ch3_line57
    dorian "Really? Is it edible?"
    voice audio.yuxuan_ch3_line29
...
label ch3_vasily_arrives:
    ...
    voice audio.svante_ch3_line6
    svante "Father has every reason and-"
    ...
    scene frostcradle_no_blizzard with fade
    show snow_blizzard_1
    voice audio.boy_ald_ch3_line2
    boy_ald_soldier "Done, sir."
    show vasily alt_aggressive at right_char with Dissolve(0.2)
    voice audio.vasily_ch3_line15
...
label ch3_fight_back:
    ...
    voice audio.dorian_ch3_line100
    dorian "Elias…"
    voice audio.dorian_ch3_line101
...
label ch3_escape:
    ...
    voice audio.dorian_ch3_line102
    dorian "Elias…"
    ...
    voice audio.elias_ch3_line60
    elias "Daddy…"

    show dorian neutral at left_char with Dissolve(0.2)
    voice audio.dorian_ch3_line103
