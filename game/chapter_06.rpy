...
#  FILE:  chapter_06.rpy
#  SCENE: CHAPTER 6 — Beneath Tianho
#
#  CONTENTS:
...
#    Section 5  — label chapter_6             (Lab Bedroom — Dorian wakes from nightmare)
#    Section 6  — label ch6_elias_choices     (D1 — 4 questions for Elias)
#    Section 7  — label ch6_elias_common      (Elias falls asleep — move to main room)
#    Section 8  — label ch6_briefing          (Lab dim — Chung-hee, Tim, situation)
#    Section 9  — label ch6_tedda_alive       (Tedda is alive — Roboto update)
#    Section 10 — label ch6_depart            (Tim insists — the group departs)
#    Section 11 — label ch6_elevator          (Black screen — elevator to surface)
#    Section 12 — label ch6_overlooking       (Overlooking Tianho at night)
#    Section 13 — label ch6_yaoguai_encounter (Timed Choice D1 — Channel Earth or Stumble)
#    Section 14 — label ch6_yaoguai_barrier   (Timed Choice D2 — Earth or Wind barrier)
#    Section 15 — label ch6_yaoguai_common    (Yaoguai common — IF YAOGUAI check / game over)
#    Section 16 — label ch6_tianho_approach   (Tianho post-tragedy — walking to Cheng store)
#    Section 17 — label ch6_jiang_gao         (Cheng Industries entrance — Jiang and Gao)
#    Section 18 — label ch6_hundun_appears    (Hundun appears — Tim explains)
#    Section 19 — label ch6_hundun_illusion_1 (Illusion 1 — Elara and family)
#    Section 20 — label ch6_vasily_room       (Illusion 2 — Vasily / Mjoll throne room)
#    Section 21 — label ch6_vasily_qtc        (Timed Choice D3 — 4 options — HARD GATE)
#    Section 22 — label ch6_rulers_illusion   (Illusion 3 — 4 rulers)
...
#    Section 26 — label ch6_hundun_defeated   (Hundun defeated — return to Tianho)
...
#
#  NAMING CONVENTIONS:
#    image tags      — bg_name, cg_name
#    audio variables — audio.ost_name, audio.sfx_name, audio.amb_name
#    label names     — ch6_name (all lowercase, underscores only)
#    game variables  — ch6_yaoguai_tracker, ch6_vasily_qtc, ch6_darkness_qtc
#    NO SPACES in any tag, label, variable, or image name.
#
#  TRACKER SUMMARY:
#    yuxuan_affection  : +1 D1 = ask about Yuxuan
#    chunghee_affection: +1 D1 = ask about Emperor
#    svante_affection  : +1 D1 = ask about violet-haired man
#    niko_affection    : +1 D1 = ask about the doctor
#    ch6_yaoguai_tracker : counts wrong QTC answers (≥2 = GAME OVER)
#
#  HARD GATES:
#    D3 Vasily choices 1 and 2 → GAME OVER
#    D4 choices 1, 3, and 4   → GAME OVER
#    ch6_yaoguai_tracker ≥ 2  → GAME OVER
#
#  PLACEHOLDER PATHS:
...
# --- Music ---
define audio.ost_lab_dim          = "audio/music/ost_lab_dim.ogg"              # PLACEHOLDER already in ch5
define audio.ost_tianho_night     = "audio/music/ost_tianho_night.ogg"         # PLACEHOLDER
# Tense quiet — approaching the ruined Tianho streets at night

define audio.ost_yaoguai_chase    = "audio/music/ost_yaoguai_chase.ogg"        # PLACEHOLDER
# Frantic — Yaoguai encountered on the way to Tianho

define audio.ost_hundun_theme     = "audio/music/ost_hundun_theme.ogg"         # PLACEHOLDER
# Warped, unsettling — the Hundun's presence; reality-bending texture

define audio.ost_illusion_family  = "audio/music/ost_illusion_family.ogg"      # PLACEHOLDER
# Distorted warmth turned horror — the family illusion sequence

define audio.ost_vasily_illusion  = "audio/music/ost_vasily_illusion.ogg"      # PLACEHOLDER
# Eerie familiarity — Vasily's throne room illusion

define audio.ost_frostcradle      = "audio/music/ost_frostcradle.ogg"          # PLACEHOLDER
# Cold, howling — Frostcradle ice battlefield

define audio.ost_feng_arrives     = "audio/music/ost_feng_arrives.ogg"         # PLACEHOLDER
# Rising relief — Feng's arrival; blue fire theme

define audio.ost_reunion          = "audio/music/ost_reunion.ogg"              # PLACEHOLDER
# Warm, bittersweet — Dorian and Feng's reunion

# --- Sound Effects ---
define audio.sfx_earth_spike      = "audio/sfx/sfx_earth_spike.ogg"            # PLACEHOLDER already in ch1
define audio.sfx_wind_blast       = "audio/sfx/sfx_wind_blast.ogg"             # PLACEHOLDER already in ch2
define audio.sfx_lightning_crack  = "audio/sfx/sfx_lightning_crack.ogg"        # PLACEHOLDER
# Sharp thundercrack — Chung-hee's lightning attacks
define audio.sfx_hundun_whisper   = "audio/sfx/sfx_hundun_whisper.ogg"         # PLACEHOLDER
# Layered distorted voices — Hundun's echo-speak
define audio.sfx_illusion_shatter = "audio/sfx/sfx_illusion_shatter.ogg"       # PLACEHOLDER
# Glass-like crack — illusion breaking
define audio.sfx_blue_fire        = "audio/sfx/sfx_blue_fire.ogg"              # PLACEHOLDER
# Feng's blue channeling fire burst
define audio.sfx_water_spear      = "audio/sfx/sfx_water_spear.ogg"            # PLACEHOLDER
# Aoi's water spear strike
define audio.sfx_heartbeat        = "audio/sfx/sfx_heartbeat.ogg"              # PLACEHOLDER already in ch1

# --- Ambient ---
define audio.amb_lab              = "audio/ambient/amb_lab.ogg"                 # PLACEHOLDER already in ch5
define audio.amb_tianho_night     = "audio/ambient/amb_tianho_night.ogg"        # PLACEHOLDER
# Distant groans, wind through ruins, far-off howling — ruined Tianho exterior at night
define audio.amb_blizzard         = "audio/ambient/amb_blizzard.ogg"            # PLACEHOLDER
# Howling frozen wind — Frostcradle ice illusion
...
#
# TRACKER SUMMARY:
#   yuxuan_affection  : +1 if D1 = ask about Yuxuan
#   chunghee_affection: +1 if D1 = ask about Emperor
#   svante_affection  : +1 if D1 = ask about violet-haired man
#   niko_affection    : +1 if D1 = ask about the doctor
#
#   ch6_yaoguai_tracker: accumulates +1 per wrong QTC answer in first encounter.
#                        ≥ 2 = GAME OVER (blood loss).
#
# CHOICE RECORDS:
#   ch6_d1_elias_choice  — "yuxuan" / "emperor" / "svante" / "niko"
#   ch6_first_qtc        — "earth" or "stumble"
#   ch6_second_qtc       — "earth" or "wind"
#   ch6_vasily_qtc       — "close_eyes" or "fire_room"
#   ch6_darkness_qtc     — "order_2" (only correct answer)
...
# =============================================================================
# Entry point — jumped to from chapter_05.rpy via 'jump chapter_6'.
# Dorian wakes from the Yaoguai King nightmare. Elias is at his side.
# =============================================================================
...
label ch6_briefing:
    ...
    scene bg_yuxuan_lab_dim with dissolve       # PLACEHOLDER — lab main room, dim glow
...
label ch6_overlooking:
    ...
    scene bg_tianho_overlooking_night with fade # PLACEHOLDER — rocky outcrop, Tianho below
...
label ch6_tianho_approach:
    ...
    scene bg_tianho_post_tragedy_night with dissolve # PLACEHOLDER — Tianho ruins at night
...
label ch6_jiang_gao:
    ...
    scene bg_cheng_store_entrance_night with dissolve # PLACEHOLDER — Cheng store entrance
...
label ch6_hundun_appears:
    ...
    scene bg_tianho_post_tragedy_night with dissolve # PLACEHOLDER — Tianho ruins
    ...
    scene cg_hundun_form with dissolve          # PLACEHOLDER — cg_hundun_form
    pause 1.5
    scene bg_tianho_post_tragedy_night with dissolve
...
label ch6_hundun_illusion_1:
    ...
    scene bg_tianho_dorians_room with shock_cut # PLACEHOLDER — Dorian's Tianho room (illusion)
    ...
    scene bg_tianho_food_stalls_fire with shock_cut # PLACEHOLDER — food stalls on fire (nightmare)
...
label ch6_vasily_room:
    ...
    scene bg_mjoll_palace_throne with shock_cut # PLACEHOLDER — Mjoll throne room (illusion)
...
label ch6_rulers_illusion:
    ...
    scene bg_mjoll_square_festive with shock_cut # PLACEHOLDER — Mjoll square (illusion)
...
label ch6_vasily_final:
    ...
    scene bg_frostcradle_ice with shock_cut     # PLACEHOLDER — Frostcradle ice wasteland
...
label ch6_hundun_defeated:
    ...
    scene bg_tianho_post_tragedy_night with dissolve # PLACEHOLDER — Tianho ruins, night
    ...
    scene bg_cheng_store_entrance_night with dissolve # PLACEHOLDER — Cheng store exterior
...
label ch6_feng_appears:
    ...
    scene bg_tianho_post_tragedy_night with dissolve # PLACEHOLDER — Tianho night
    ...
    scene cg_feng_arrives with dissolve         # PLACEHOLDER — cg_feng_arrives
    pause 1.5
    scene bg_tianho_post_tragedy_night with dissolve
