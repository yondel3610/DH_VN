...
label chapter_4:
    ...
    voice audio.gustav_ch4_line1
    king_gustav "Count Vasily… dead."
    voice audio.gustav_ch4_line2
    king_gustav "My right hand man… I… I can't believe this."
    voice audio.gustav_ch4_line3
    ...
    voice audio.gustav_ch4_line16
    king_gustav "Forget Dorian. We have a new target."
    voice audio.gustav_ch4_line17
...
label ch4_kyeongjang:
    ...
    voice audio.sunwoo_ch4_line1
    captain_sunwoo "Pyeha, I humbly wish you a most joyous birthday."
    voice audio.sunwoo_ch4_line2
    captain_sunwoo "May your reign continue to bring light and prosperity to Kyeongjang for many decades to come."
    ...
    voice audio.sunwoo_ch4_line3
    captain_sunwoo "Pyeha, forgive me for addressing you on such a day of celebration, but I must say this."
    voice audio.sunwoo_ch4_line4
    captain_sunwoo "Things are looking brighter for Kyeongjang."
    voice audio.sunwoo_ch4_line5
    captain_sunwoo "Trade has flourished within our borders, and our crops yield twice what they did last year."
    voice audio.sunwoo_ch4_line6
    captain_sunwoo "Under your divine hand, the people see you as their protector, their guiding light."
    voice audio.sunwoo_ch4_line7
    ...
    show captain_kang at left_char with Dissolve(0.2)
    voice audio.sunwoo_ch4_line8
    captain_sunwoo "Pyeha, the people adore you. Kyeongjang grows stronger with each passing day under your rule."
    voice audio.sunwoo_ch4_line9
    captain_sunwoo "You are their guiding star"
    show ya_ji_hye at right_char with Dissolve(0.2)
...
label ch4_chunghee_qtc:
    ...
    menu:
        ...
        "Trick Aunt Ji-Hye.":
            ...
            voice audio.sunwoo_ch4_line13
            captain_sunwoo "Ji-hye-nim, I'm sorry. I should've arrived sooner… this isn't your fault."
            voice audio.sunwoo_ch4_line14
            captain_sunwoo"You did everything you could."
        ...
        "Make Aunt Ji-hye go to sleep.":
            ...
            voice audio.sunwoo_ch4_line22
            captain_sunwoo "Pyeha, forgive me for my boldness, but I understand you intend to leave the palace tonight."
            voice audio.sunwoo_ch4_line23
            captain_sunwoo "I must implore you to reconsider."
            chung_hee      "Captain, I appreciate your concern, but my decision is final."
            voice audio.sunwoo_ch4_line24
...
label ch4_cemetery:
    ...
    voice audio.dorian_ch4_line8
    dorian "It's been years. I've missed you all so much."
    "I swallowed hard, my vision blurring as tears welled up in my eyes."
    voice audio.dorian_ch4_line9
    dorian "I've been wandering for so long, trying to find my place in this world."
    voice audio.dorian_ch4_line10
    dorian "But I never forgot you, and I never will."
    "My voice cracked as I choked back a sob."
    voice audio.dorian_ch4_line11
    dorian "I'm so sorry for everything. I should have protected you."
    ...
    yuxuan "I believe it's our responsibility to share it with the world, to make a difference."
...
label ch4_yuxuan_convo:
    ...
    menu:
        "Continue to wait patiently.":
            ...
            voice audio.yuxuan_ch4_line15
            yuxuan "We can't afford to have any more delays."
            voice audio.yuxuan_ch4_line16
...
label ch4_yuxuan_common:
    ...
    dorian "It's been a long time since I've been able to visit my family. Thank you for bringing us here."
    voice audio.dorian_ch4_line26
    dorian "And I saw what you did with the flowers. It means a lot."
    voice audio.dorian_ch4_line27
...
label ch4_cemetery_exit:
    ...
    yuxuan "And now I'm being treated like some kind of threat? This is absolutely outrageous!"
    ...
    tian_xun "I could clear this whole area with one of my beauties, you know."
    voice audio.tianxun_ch4_line4
    tian_xun "One boom, and everyone's gone! It'd be a lesson in obedience, wouldn't it?"

    voice audio.svante_ch4_line17
    svante "Sir Tian Xun. Please, that won't be necessary. Our goal was to—"
    voice audio.tianxun_ch4_line5
    tian_xun "Oh, but think of the possibilities, Svante! A controlled explosion right here and now—imagine it!"
    voice audio.tianxun_ch4_line6
    ...
    voice audio.tianxun_ch4_line7
    tian_xun "Ashamed? HAHAHAHA! My parents were nobodies! Farmers!"
    voice audio.tianxun_ch4_line8
    tian_xun "What did they ever give me except poverty and a back-breaking life, old fool?"
    voice audio.tianxun_ch4_line9
    tian_xun"Gustav gave me wealth, power, and the means to create. Go, my beauties! BOOM! BOOM!"
    voice audio.tianxun_ch4_line10
    ...
    voice audio.tianxun_ch4_line11
    ...
    voice audio.niko_ch4_line7
    niko    "Hmm… that toy… I remember…"
    voice audio.niko_ch4_line8
    ...
    voice audio.yuxuan_ch4_line47
    yuxuan "What is going on? Why is everyone acting like this?"
    voice audio.dorian_ch4_line36
    ...
    voice audio.tianxun_ch4_line14
    ...
    menu:
        ...
        "Stumble! Elias, help!":
            ...
            voice audio.elias_ch4_line26
            elias  "Tedda! We did it!"
            show dorian neutral at left_char with Dissolve(0.2)
            voice audio.dorian_ch4_line42
...
label ch4_battlefield:
    ...
    voice audio.girl_ald_ch4_line7
    ...
    voice audio.dorian_ch4_line51
    dorian "Listen to me. The clinic—it's a little far from here, but I'll carry you. Just hold on, alright?"
    voice audio.dorian_ch4_line52
    dorian "I'll do what I can."
...
label ch4_svante_capture:
    ...
    voice audio.tianxun_ch4_line21
    tian_xun "My cannons! My beautiful cannons! They ruined everything! Do you know how long it took me to design those?"
    voice audio.tianxun_ch4_line22
    tian_xun "The fuses, the powder, the precision—ruined!"
    ...
    voice audio.tianxun_ch4_line24
    ...
    show tian_xun at center_char with Dissolve(0.2)
    voice audio.tianxun_ch4_line40
    ...
    voice audio.tianxun_ch4_line28
    ...
    voice audio.aoi_ch4_line18
    aoi      "Wait… That's not…"
    voice audio.tianxun_ch4_line31
    tian_xun "YES!! YES!! HAHAHAHAHA!!"

    voice audio.aoi_ch4_line19
    aoi      "You're insane! You can't use that here, Tian Xun! You'll destroy us all!"
    voice audio.tianxun_ch4_line32
    tian_xun "Destroy us? Oh, Aoi, don't be so dramatic. This. Is. Progress!"
    voice audio.tianxun_ch4_line33
    tian_xun "This is the culmination of my Tianho roots, my art! Draconic fire, distilled into its purest, most destructive form!"
    ...
    voice audio.tianxun_ch4_line44
...
label ch4_prosperity_dragon:
    ...
    "{i}My child…{/i}"
    voice audio.dorian_ch4_line71
    "My breath hitched. That voice—it was unmistakable."

    voice audio.dorian_ch4_line72
    dorian "…?"
    ...
    menu:
        ...
        "Remember the people who died at Mjoll because of you.":
            ...
            scene black with shock_cut
            voice audio.vasily_ch4_line1
            vasily "My friend… How could you kill me?"
            voice audio.dorian_ch4_line82
...
label ch4_draconic_fire:
    ...
    voice audio.tianxun_ch4_line45
    tian_xun "HAHAHAHA! YES! YES!!"
    voice audio.tianxun_ch4_line46
    tian_xun "Prosperity Dragon, witness this moment! Witness your loyal servant's ultimate sacrifice!"
    voice audio.tianxun_ch4_line47
    tian_xun"Let my ashes be your offering! Let this field become your altar! THIS… IS TRUE ART!"
    voice audio.tianxun_ch4_line48
    ...
    voice audio.niko_ch4_line41
    niko "Everyone, get behind my shadows!"
    voice audio.yuxuan_ch4_line67
    yuxuan "O-Okay…"
    voice audio.niko_ch4_line42
    niko "Dorian, you too."
    ...
    show svante normal_nervous at right_char
    with Dissolve(0.2)
    voice audio.yuxuan_ch4_line68
    yuxuan "Dorian…"
    voice audio.svante_ch4_line43
    svante "What the…"
    hide svante
    hide yuxuan
    ...
    yuxuan "It's hidden, secure and there's no way anyone will find us there."
    voice audio.yuxuan_ch4_line73
...
label ch4_underground:
    ...
    voice audio.yuxuan_ch4_line77
    yuxuan "Is everyone alright?"
    voice audio.niko_ch4_line50
    ...
    "And then—"
    voice audio.aoi_ch4_line29
    aoi "Ti… Tian Xun…"

    "A pause."
    "Then, a bloodcurdling scream."
    voice audio.aoi_ch4_line30
    aoi "TIAN XUN!!"
    ...
    voice audio.svante_ch4_line49
    svante "It's raining now."

    voice audio.niko_ch4_line51 
