...
#  FILE:  chapter_09.rpy
#  SCENE: CHAPTER 9 — The Fifth Anniversary (Part 1)
#  POV: Dorian
###############################################################################
...
label chapter_9:
    ...
    scene black with fade              # PLACEHOLDER — lab bedroom
    ...
    show elias sleepware_happy at right_char_kids
    with Dissolve(0.2)
    ...
    "In just a single day, I met Chung-hee, the Emperor of Kyeongjang; Niko, a prophet of the death god; and Svante, an aldorith who had switched sides."
    "I had met Miss Weng, Yuxuan's trusted helper, Roboto, Yuxuan's automaton, and Tim, the brilliant toddler who somehow always knew more than he should."
    ...
    "And we met and fought Magnus. The man from my dreams."
    show dorian sleepware_serious at left_char with Dissolve(0.1)
    "What happened to him? Why had he been sealed in ice for centuries?"
    "And what memories had been implanted into his mind, twisting him into something even he didn't recognize?"
    ...
    show elias sleepware_neutral at right_char_kids with Dissolve(0.1)
    "He swayed a little in his seat, blinking drowsily, fighting sleep the way all kids his age did."
    "I knew from experience that Elias never fell asleep quickly. If I helped him, maybe he'd drift off sooner."
    show dorian sleepware_serious at left_char with Dissolve(0.1)
    "But at the same time, I haven't checked up on Magnus yet. Who knew what was happening in his mind?"
    "If he woke up confused-or worse, hostile again-he could be a danger to everyone."
    show dorian sleepware_neutral at left_char with Dissolve(0.1)
...
label ch9_common:
    scene yuxuan_manor with fade           # PLACEHOLDER — lab main area
    ...
    scene lab_cave_on with dissolve              # PLACEHOLDER — kitchen
    ...
    "She took the daikon from his hands and, with precise, elegant movements, she pressed the blade against the radish's smooth surface."
    ...
    "He wasn't just chopping vegetables-he was conducting a symphony. Every stroke of his knife was a masterful flourish."
    "His brown hair shimmered under the kitchen lights, swaying with every precise movement as he diced, sliced, and minced."
    ...
    show weng alt_nervous at right_char with Dissolve(0.1)
    "Weng turned toward me, her brow furrowing."
...
label ch9_library:
    ...
    "I remembered my time as a Paladin in the service of Empress Olympia."
    "We had a special library, a grand hall dedicated solely to the knowledge that Paladins were meant to wield. Not just books on war strategy and elemental channeling, but history, philosophy, even works of art."
    ...
    "Mahogany bookshelves stretched as far as the eye could see, their golden inlays shimmering under the glow of soft, floating lanterns."
    "The ceiling loomed far above me, at least forty feet high, with delicate metal bridges connecting the upper floors."
    ...
    "Chung-hee didn't even glance up when I approached. His eyes remained fixed on the pages before him, scanning each line with sharp, unwavering focus."
    "His brow furrowed slightly, his lips pressed together in concentration."
    ...
    "Before I could press him further, he flipped back a few pages, cross-referencing something in the text."
    "His fingers began tapping against the wooden table, a nervous habit I had come to recognize-his mind was racing, processing faster than he could communicate."
    ...
    menu:
        "Press further for more details about his aunt.":
            ...
            show dorian normal_alt_calm at left_char with Dissolve(0.1)
            "The pressure lifted as quickly as it came, but the silence it left in its wake was suffocating."
            "He was right. I had known him for only a day and a half."
...
label ch9_library_common:
    ...
    pause 1.5
    "Minutes passed in quiet. The library remained hushed, save for the occasional soft rustle of pages turning."
    "I kept reading, but my focus wavered, my mind drifting between the words on the page and the thoughts circling my head."
...
label ch9_bedroom_yuxuan:
    ...
    "I stood by the bedside, watching Elias sleep. His small body was curled up, his face relaxed in peaceful slumber."
    "His chest rose and fell in a steady rhythm, his tiny fingers clutching at the blanket. Safe. Warm. Untroubled."

    hide elias sleepware_neutral
    show dorian neutral at left_char
    ...
    menu:
        ...
        "Eat with Yuxuan.":
            ...
            "I picked up a crispy fish treat, the heat still lingering on its surface."
    ...
    "A small rustling from the bed caught my attention. "
...
label ch9_tavern:
    ...
    "In the spirit of the festivities, I decided to have a drink. After all that's happened, damn, I think I deserved one."
    "But I needed to be cautious."
    "I had only managed to get to Tianho under the cover of night yesterday. Now, with the sun up, the city was alive—and that meant guards. More alive so since the today is the Anniversary of the Tragedy."

    # play sound sfx_door_chime                # PLACEHOLDER — not declared
    scene underground_door with dissolve

    # door_voice — no sprite, disembodied voice
    ...
    "The walk to Tianho was uneventful, but as soon as I got close, the energy of the city hit me like a wave. "
    scene bg_tianho_city_morning with dissolve
    "The streets were alive with movement-vendors calling out their wares, children weaving through the crowds with paper lanterns, and musicians playing soft, somber tunes on guqins and flutes."
    ...
    with Dissolve(0.2)
    mjoll_soldier_1 "Bottoms up! Haha!"
    mjoll_soldier_2 "Hey! No fair, you cheating swine! My cup's barely half-full!"
    ...
    menu:
        ...
        "Eat with Niko.":
            ...
            show dorian normal_alt_neutral at left_char
            "I followed his line of sight to a man pulling a wooden cart down the street, its wheels creaking softly over the stone path. "
    ...
    scene bg_tianho_city_morning with dissolve # PLACEHOLDER — Tianho streets

    "The steady beat of drums and the lilting notes of flutes filled the streets as we wove through the growing crowd."
    "The air buzzed with conversation, laughter, and the occasional call of a vendor hawking their wares."
    ...
    show dorian normal_alt_annoyed at left_char with Dissolve(0.1)
    "I frowned. Xingcao? The name was unfamiliar to me."
    ...
    "Aoi's gaze lingered on a family sitting nearby-an elderly woman pouring tea with careful, practiced hands, serving two younger figures."
...
label ch9_kitchen_help:
    ...
    "Svante stiffened slightly, his knife pausing mid-air for just a fraction of a second."
    ...
    "Neither of us held back-Feng never allowed it. He fought with relentless precision, his movements sharp and calculated, like a blade honed to perfection."
    show dorian normal_alt_neutral at left_char with Dissolve(0.1)
    "But outside of battle? He was my closest friend."
    show dorian normal at left_char with Dissolve(0.1)
    "I huffed a quiet laugh."
    show dorian neutral at left_char with Dissolve(0.1)
    "For all his discipline in combat, he had a habit of skipping training entirely-just so he could sit under a tree with a romance novel in hand."
    ...
    show svante normal_base at right_char with Dissolve(0.1)
    "We continued cutting, the rhythmic thud of our knives filling the kitchen as the pile of onions gradually shrank."
    "The sharp scent burned my eyes slightly, but I pushed through, matching Svante's steady pace."
...
# =============================================================================
# SECTION 14: LABEL CH9_KITCHEN_COMMON — After Cooking Common
# =============================================================================
...
label ch9_kitchen_common:
    ...
    hide magnus
    show roboto happy at center_robot with Dissolve(0.2)
    "Roboto, however, didn't seem the least bit fazed by Magnus' impromptu serenade."
    "The little automaton simply adjusted its grip on the spatula before addressing Svante again."
    ...
    "By the time Weng and Tedda returned, the counters were neatly arranged with trays of prepped vegetables, cleaned fish, and marinated meats."
    "Weng smiled in approval before effortlessly taking over the more delicate cooking-frying, broiling, and adjusting flavors with practiced ease."
    ...
    menu:
        ...
        "Keep on listening.":
            ...
            "Magnus' eyes were half-closed as he sang, completely lost in the music. His fingers tapped lightly against his knee, keeping time with a rhythm only he could hear."
            "There was something unguarded about him in this moment, something raw beneath the usual bravado."
...
label ch9_outfit_gather:
    ...
    scene yuxuan_manor with fade           # PLACEHOLDER — lab main room
    
    "Hours passed, and as the evening settled in, Yuxuan called for all of us to gather in the living room."
    "He entered with his usual air of effortless grace, his long crimson robes flowing like mist over water."
    "His presence alone was enough to quiet the room."
    show yuxuan normal_neutral at center_char
    show dorian normal_alt_neutral at left_char 
    show weng normal at right_flip 
    with Dissolve(0.2)
    "Weng followed closely behind him, her arms stacked with neatly folded garments, each one shimmering under the lantern light."
    ...
    scene spare_room with Dissolve(0.75)          # PLACEHOLDER — lab bedroom
    "A gentle but firm knock echoed from the door. I sighed, setting aside my cup as I got up to answer."
    show roboto happy at right_robot
    show dorian neutral at left_char
    with Dissolve(0.2)
    "The moment I pulled the door open, I found myself face-to-face with Roboto, its metallic figure standing stiffly in the hallway."
