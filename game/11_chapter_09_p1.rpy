...
label chapter_9:
    ...
    show elias sleepware_happy at right_char_kids with Dissolve(0.2)
    ...
    show elias sleepware_neutral at right_char_kids
    ...
    show elias sleepware_mad at right_char_kids
...
label ch9_elias_choice:
    ...
    menu:
        ...
        "Stay with Elias and help him sleep.":
            ...
            show dorian sleepware_smile at left_char
...
label ch9_common:
    ...
    show magnus clothed_wings at right_char with Dissolve(0.2)
    ...
    hide magnus
    show svante alt_weird at right_char with Dissolve(0.2)
...
label ch9_library_common:
    ...
    # Poem — no sprites, narration only
...
label ch9_bedroom_yuxuan:
    ...
    # Memory / dialogue lines — no sprites, narration only
...
label ch9_tavern:
    ...
    # man_1, man_2 — no sprites, voice only
    ...
    # woman_2, man_2 — no sprites, voice only
...
label ch9_kitchen_help:
    ...
    hide magnus
    show svante normal_ignore at right_char with Dissolve(0.2)
    ...
    show svante alt_guilty at right_char with Dissolve(0.2)
...
label ch9_kitchen_common:
    ...
    menu:
        ...
        "Keep on listening.":
            ...
            show magnus alt_smirk at right_char with Dissolve(0.2)
...
label ch9_outfit_gather:
    ...
    hide elias normal_sad
    show elias normal_mad at right_char_kids with Dissolve(0.2)
